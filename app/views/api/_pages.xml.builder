    ...
    xml.taxon do
      ...
      for object in details_hash["data_objects"]
        if data_object_details
          xml << render(:partial => 'data_object.xml.builder', :layout => false, :locals => { :data_object => object, :minimal => false } )
        else
          xml << render(:partial => 'data_object.xml.builder', :layout => false, :locals => { :data_object => object, :minimal => true } )
        end
      end
    end
  end
